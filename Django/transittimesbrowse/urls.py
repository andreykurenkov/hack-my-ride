...
urlpatterns = patterns('',
    ...
    url(r'(?P<agency_id>.+)/routes/(?P<route_id>\d+)/stops/(?P<stop_id>\d+)/$', 'transittimesbrowse.views.stop', name='stop'),
    url(r'(?P<agency_id>.+)/routes/(?P<route_id>\d+)/stops/(?P<stop_id>\d+)/trip/(?P<trip_id>\d+)$', 'transittimesbrowse.views.trip', name='trip')
)
