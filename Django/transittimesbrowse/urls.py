...
from transittimesbrowse.views import (
    ByAgencyListView, FareRuleByFareListView, FareRuleByRouteListView,
...
urlpatterns = patterns('',
    url(r'(?P<agency_id>\d+)/routes/$', ByAgencyListView.as_view(model=Route), name='route_list'),
